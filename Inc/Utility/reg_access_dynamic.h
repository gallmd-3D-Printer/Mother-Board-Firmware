...
//
  ...
  #define MCAL_REG_DYNAMIC_ACCESS_TEMPLATE_2013_12_13_H_
      ...
      struct dynamic_access final
      {
        ...
        static void reg_and_not(const register_address_type address, const register_value_type value) {*reinterpret_cast<volatile register_value_type*>(address) & (~value);}
        ...
        static void reg_xor(const register_address_type address, const register_value_type value) { *reinterpret_cast<volatile register_value_type*>(address) ^= value;}
