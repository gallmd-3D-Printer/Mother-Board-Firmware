...
I2CMaster2::I2CMaster2(I2C::BaseRegisterType baseRegister)
{
...
int I2CMaster2::sendBytes(uint8_t * sendBuffer, uint8_t address, uint8_t messageLength)
{
...
//	reg_access<GPIOxRegisterType, GPIOxRegisterType, (GPIOxBaseRegisters::GPIO_B + RegisterOffsets::OutputDataRegisterOffset), Util::Bits::BIT12>::reg_xor();

	 if(status & I2C::StatusRegister1::StartBit){

		 //send address
		 //0x40005410
		 dynamic_access<I2C::BaseRegisterType, uint8_t>::reg_set(dataRegister, slaveAddress);
	...
	if((status & I2C::StatusRegister1::TransmitEmpty)){ 	//& (status & I2C::StatusRegister1::ByteTransferFinished)
		...
		if((bytesSent > bytesToSend) & (!dataSent)){
			...
			dataSent = true;
			//0x40005400
			dynamic_access<I2C::BaseRegisterType, uint16_t>::reg_or(I2CMaster2::controlRegister1, I2C::ControlRegister1::Stop);
...
void I2CMaster2::ER_handler()
{

	dynamic_access<I2C::BaseRegisterType, I2C::ControlRegister1Type>::reg_or(I2CMaster2::controlRegister1, I2C::ControlRegister1::SoftwareReset);


}

void I2CMaster2::registerInterrupt()
{
...
void I2CMaster2::handleInterrupts(int interruptType){

  I2CMaster2::EV_handler();
