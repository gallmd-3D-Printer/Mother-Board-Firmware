...
//    typedef std::array<uint8_t, 17>send_buffer_type;
        typedef uint8_t send_buffer_type[17];
	...
	namespace ControlRegister1
	{
		...
		/**
		  ...
		  */
		constexpr ControlRegister1Type SoftwareReset = Util::Bits::BIT15;
		/**
		 ...
		 *
		 */
		constexpr ControlRegister1Type Alert = Util::Bits::BIT13;
		/**
		 ...
		 *
		 */
		constexpr ControlRegister1Type PEC = Util::Bits::BIT12;
		/**
		 ...
		 */
		constexpr ControlRegister1Type POS = Util::Bits::BIT11;
		/**
		 ...
		 *
		 */
		constexpr ControlRegister1Type ACK = Util::Bits::BIT10;
		/**
		 ...
		 */
		constexpr ControlRegister1Type Stop = Util::Bits::BIT9;
		/**
		 ...
		 */
		constexpr ControlRegister1Type Start = Util::Bits::BIT8;
		/**
		 ...
		 *
		 */
		constexpr ControlRegister1Type NoStretch = Util::Bits::BIT7;
		/**
		 ...
		 */
		constexpr ControlRegister1Type GeneralCallEnbable = Util::Bits::BIT6;
		/**
		 ...
		 *
		 */
		constexpr ControlRegister1Type PECEnable = Util::Bits::BIT5;
		/**
		 ...
		 */
		constexpr ControlRegister1Type ARPEnable = Util::Bits::BIT4;
		/**
		 ...
		 *
		 */
		constexpr ControlRegister1Type SMBusType = Util::Bits::BIT3;
		/**
		 ...
		 * 			1: SMBus Mode
		 */
		constexpr ControlRegister1Type SMBusMode = Util::Bits::BIT1;
		/**
		 ...
		 *
		 */
		constexpr ControlRegister1Type PeripheralEnable = Util::Bits::BIT0;
	...
	namespace ControlRegister2
	{
		 ...
		 */
		constexpr ControlRegister2Type DMALast = Util::Bits::BIT12;
		/**
		 ...
		 *
		 */
		constexpr ControlRegister2Type DMAEnable = Util::Bits::BIT11;
		/**
		 ...
		 * 			the state of DMAEN)
		 */
		constexpr ControlRegister2Type BufferInterruptEnable = Util::Bits::BIT10;
		/**
		 ...
		 *
		 */
		constexpr ControlRegister2Type EventInterruptEnable = Util::Bits::BIT9;
		/**
		 ...
		 *
		 */
		constexpr ControlRegister2Type ErrorInterruptEnable = Util::Bits::BIT8;
	...
	namespace OwnAddressRegister
	{
		 ...
		 *
		 */
		constexpr OwnAddressRegisterType AddressMode = Util::Bits::BIT15;
		/**
		 * @brief Mystery bit - Manual states that this bit should always be kept
		 * 			at 1 by software.
		 */
		constexpr OwnAddressRegisterType MysteryBit = Util::Bits::BIT14;
	...
	namespace OwnAddressRegister2
	{
		 ...
		 *
		 */
		constexpr OwnAddressRegister2Type EnableDualAddress = Util::Bits::BIT0;
	...
	namespace StatusRegister1
	{
		 ...
		 */
		constexpr StatusRegister1Type SMBusAlert = Util::Bits::BIT15;
		/**
		 ...
		 * 			- cleared by software writing 0, or by hardware when PE = 0
		 */
		constexpr StatusRegister1Type Timeout = Util::Bits::BIT14;
		/**
		 ...
		 *
		 */
		constexpr StatusRegister1Type PECError = Util::Bits::BIT12;
		/**
		 ...
		 * 		error occurs.
		 */
		constexpr StatusRegister1Type OverrunUnderrun = Util::Bits::BIT11;
		/**
		 ...
		 *
		 */
		constexpr StatusRegister1Type AcknowledgFailure = Util::Bits::BIT10;
		/**
		 ...
		 */
		constexpr StatusRegister1Type ArbitrationLost = Util::Bits::BIT9;
		/**
		 ...
		 *
		 */
		constexpr StatusRegister1Type BusError = Util::Bits::BIT8;
		/**
		 ...
		 *
		 */
		constexpr StatusRegister1Type TransmitEmpty = Util::Bits::BIT7;
		/**
		 ...
		 *
		 */
		constexpr StatusRegister1Type ReceiveNotEmpty = Util::Bits::BIT6;
		/**
		 ...
		 *
		 */
		constexpr StatusRegister1Type StopDetected = Util::Bits::BIT4;
		/**
		 ...
		 *
		 */
		constexpr StatusRegister1Type ADD10 = Util::Bits::BIT3;
		/**
		 ...
		 */
		constexpr StatusRegister1Type ByteTransferFinished = Util::Bits::BIT2;
		/**
		 ...
		 */
		constexpr StatusRegister1Type Address = Util::Bits::BIT1;
		/**
		 ...
		 */
		constexpr StatusRegister1Type StartBit = Util::Bits::BIT0;
	...
	namespace StatusRegister2
	{
		 ...
		 *
		 */
		constexpr StatusRegister2Type DualAddressFlag = Util::Bits::BIT7;
		/**
		 ...
		 *
		 */
		constexpr StatusRegister2Type SMBHost = Util::Bits::BIT6;
		/**
		 ...
		 *
		 */
		constexpr StatusRegister2Type SMBDefault = Util::Bits::BIT5;
		/**
		 ...
		 * 			START condition, or when PE = 0.
		 */
		constexpr StatusRegister2Type GeneralCall = Util::Bits::BIT4;
		/**
		 ...
		 *
		 */
		constexpr StatusRegister2Type TRA = Util::Bits::BIT2;
		/**
		 * @brief BUSY - Bus Busy
		 *
		 ...
		 *
		 */
		constexpr StatusRegister2Type Busy = Util::Bits::BIT1;
		/**
		 ...
		 *
		 */
		constexpr StatusRegister2Type MasterSlave = Util::Bits::BIT0;
	...
	namespace ClockControlRegister
	{
		 ...
		 *
		 */
		constexpr ClockControlRegisterType FastSlow = Util::Bits::BIT15;
		/**
		 ...
		 *
		 */
		constexpr ClockControlRegisterType Duty = Util::Bits::BIT14;
	...
	namespace FilterRegister
	{
		 ...
		 * 			disabled (PE = 0).
		 */
		constexpr FilterRegisterTYpe AnalogFilterOff = Util::Bits::BIT4;
	}

}

extern interruptable * handlerPointers[sizeof(peripheralInterrupts)];
class I2CMaster2 : public interruptable{

public:
    I2CMaster2(I2C::BaseRegisterType baseRegister);
    int sendBytes(uint8_t * sendBuffer, uint8_t address, uint8_t messageLength);

//    static I2CMaster2* handlers[1];
